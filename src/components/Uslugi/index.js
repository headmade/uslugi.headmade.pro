    ...
    <div className="row">
      <div className="columns">
        <div className="popular-services-wrapper">
          <h2 className="base-caption base-caption--center base-caption--undefined">Популярные услуги</h2>
          ...
          <Link className="btn button-arrow-right" to="/uslugi">Все услуги</Link>
        </div>
      </div>
    </div>
  </div>
